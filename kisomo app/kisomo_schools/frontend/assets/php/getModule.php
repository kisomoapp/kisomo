<?php
    ...
    "SELECT m.module_title,r.file_link,m.module_description,m.duration_in_minutes,r.module_type
     FROM school_topic_modules m,school_resources r WHERE m.resource_id=r.resource_id AND m.module_id=$moduleId");
